    ...
    <footer className="footer">
      ...
      >
        ...
        <div className="footer-social">
          ...
          {/* YouTube */}
          <a href="https://youtube.com/@dr.jeelansmedicalhub?si=ASdMZeQFleB9UKMM"target="_blank"rel="noopener noreferrer"aria-label="YouTube">
            <svg width="16" height="16" viewBox="0 0 24 24" fill="currentColor">
          ...
          {/* Facebook */}
          <a href="https://www.facebook.com/share/1EZt9AVQb1/" target="_blank" rel="noopener noreferrer" aria-label="Facebook">
            <svg width="16" height="16" viewBox="0 0 24 24" fill="currentColor">
